    ...
    <div id="resule-status-scrollWrap" v-show="ui.statusScrollWrap">
      ...
      <div class="optContainer" style="height: 18.6rem; overflow-y:auto;">
        ...
        <div id="resule-status-body">
          <p class="youraward" style="font-size:0.8rem; line-height:1.2rem">您的成绩为：<span class="resuleArg" style="font-size:0.8rem;">{{params.gameScore}}</span><span class="result-scoreUnit" style="font-size:0.8rem;"><span class="gameScoreUnit">分</span></span>
          </p>
          <p class="youraward costTime hide" style="font-size:0.8rem; line-height:1.2rem">达到该成绩用时：<span class="resuleArg" style="font-size:0.8rem;">{{params.gameCostTime}}</span><span class="result-scoreUnit" style="font-size:0.8rem;">秒</span></p>
          ...
          <p class="resule-status-minscorex" style="display:none;">成绩必须达到 <span class="resuleArg resulescoreLimit">{{params.minScore}}</span> <span class="gameScoreUnit">分</span>才能<span id="minscoreDrawFont">抽奖</span></p>

          <p id="bestArg" style="margin-top:0.5rem">最佳成绩为：<span class="resuleArg">{{params.bestScore}}</span><span class="result-scoreUnit"><span class="gameScoreUnit">分</span></span>
          </p>
        ...
        <div id="resule-status-other" class="hide">
          ...
          <p class="resule-status-minscorex hide" style="margin: 10px 0px 50px;">成绩必须达到 <span class="resuleArg resuleArg-fail resulescoreLimit">{{params.minScore}}</span> <span class="gameScoreUnit">分</span>才能抽奖</p>
        </div>
      ...
      <div class="attentionBox">
        ...
        <div class="hdskillInfo skillInfo theRunningAdClass"><a class="theSpecialTarget" href="">我也要创建活动</a>

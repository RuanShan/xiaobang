    ...
    <div id="resule-status-scrollWrap" v-show="ui.statusScrollWrap">
      ...
      <div class="optContainer" style="height: 18.6rem; overflow-y:auto;">
        ...
        <div id="resule-status-body">
          <p class="youraward" style="font-size:0.8rem; line-height:1.2rem">您的成绩为：<span class="resuleArg" style="font-size:0.8rem;">{{params.gameScore}}</span><span class="result-scoreUnit" style="font-size:0.8rem;"><span class="gameScoreUnit">秒</span></span>
          </p>
          ...
          <p class="resule-status-minscorex" style="display:none;">成绩必须达到 <span class="resuleArg resulescoreLimit">{{params.minScore}}</span> <span class="gameScoreUnit">秒</span>才能<span id="minscoreDrawFont">抽奖</span></p>
        ...
        <div id="resule-status-other" class="hide">
          ...
          <p class="resule-status-minscorex hide" style="margin: 10px 0px 50px;">成绩必须达到 <span class="resuleArg resuleArg-fail resulescoreLimit">{{params.minScore}}</span> <span class="gameScoreUnit">秒</span>才能抽奖</p>
        </div>
